...
public class ConfigHandler {
    ...
    private static final String[] insert_sql = new String[]{
            "INSERT INTO `sys_security_config`(`id`, `name`, `code`, `value`, `des`, `sort`) VALUES (1, '初始化状态（1=已完成，2=项目重启后执行初始化）', 'init_status', '1', NULL, 100);\n",
            ...
            "INSERT INTO `sys_security_config`(`id`, `name`, `code`, `value`, `des`, `sort`) VALUES (5, 'root账号，项目首次启动后，必须修改', 'root_account_is_create', 'false', NULL, 100);\n",
            ...
            "INSERT INTO `sys_security_config`(`id`, `name`, `code`, `value`, `des`, `sort`) VALUES (13, '开放路径', 'public_url', '/static/,public/', NULL, 100);\n",
            "INSERT INTO `sys_security_config`(`id`, `name`, `code`, `value`, `des`, `sort`) VALUES (14, '权限检查是否开启', 'rbac_is_open', 'true', NULL, 100);\n",
